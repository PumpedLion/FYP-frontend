...
import 'ManuscriptDetailPage.dart'; // <--- NEW IMPORT
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: isDesktop ? const [SizedBox(width: 20)] : [
          IconButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const NotificationsPage())).then((_) {
                 _fetchNotifications();
              });
            },
            icon: Badge(
              ...
              child: const Icon(Icons.notifications_none_outlined, color: Color(0xFF1D2939)),
            ),
          ),
      ...
      children: [
        ...
        IconButton(
          ...
          icon: Badge(
            label: Text('$_unreadCount'),
            isLabelVisible: _unreadCount > 0,
            child: const Icon(Icons.notifications_none_outlined, color: Colors.blueGrey),
          ),
        ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ManuscriptDetailPage(manuscript: manuscript),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
