...
class ManuscriptCard extends StatelessWidget {
  ...
  final String? authorAvatarUrl, updatedAt, coverUrl;
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(
                            coverUrl ?? "https://picsum.photos/seed/${title.hashCode}/500/800"),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _statItem(Icons.access_time, _formatDate(updatedAt)),
                    ],
                  ),
                ],
              ),
